...
/**
 * Created by Guillermo on 26/10/2015.
 */
@Path("stings")
public class StingResource {
    ...
    public Response createSting(@FormParam("subject") String subject, @FormParam("content") String content, @Context UriInfo uriInfo) throws URISyntaxException, URISyntaxException {
